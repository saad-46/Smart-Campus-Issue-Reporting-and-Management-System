...
export default function Sidebar() {
  ...
  const navLinks: NavLink[] = isAdmin
    ? [
        { name: "Dashboard", href: "/admin", icon: iconPath("M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z") },
        { name: "Report Issue", href: "/dashboard/report", icon: iconPath("M12 4v16m8-8H4") },
      ]
    : isWorker
    ? [
        { name: "My Tasks", href: "/worker", icon: iconPath("M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4") },
        { name: "Report Issue", href: "/dashboard/report", icon: iconPath("M12 4v16m8-8H4") },
      ]
    : [
